...
struct msdc_ett_settings msdc0_ett_settings_for_sandisk[] = {
	...
	{MSDC_HS200_MODE, 0xf0, (0x1f << 16), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_CMDRDLY]*/
	{MSDC_HS200_MODE, 0xf0, (0x1f << 22), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_CMDRRDLY]*/

	/* write ett settings */
	{MSDC_HS200_MODE, 0xb4, (0x7 << 0), 0x1},	/*PATCH_BIT1[MSDC_PB1_WRDAT_CRCS_TA_CNTR]*/
	{MSDC_HS200_MODE, 0xf0, (0x1f << 0), 0x0},	/*PAD_TUNE0[MSDC_PAD_TUNE_DATWRDLY]*/
	...
	/* read ett settings */
	{MSDC_HS200_MODE, 0xf0, (0x1f << 8), 0x0},	/*PAD_TUNE[MSDC_PAD_TUNE_DATRRDLY]*/
