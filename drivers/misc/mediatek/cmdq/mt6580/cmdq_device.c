...
void cmdq_dev_init_module_PA_stat(void)
{
	...
	for (i = CMDQ_MODULE_STAT_DISP_OVL0; i <= CMDQ_MODULE_STAT_DISP_UFOE; i++) {
		cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS",
						    (i - CMDQ_MODULE_STAT_DISP_OVL0),
						    &modulePAStat->start[i], &modulePAStat->end[i]);
	}
	cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS", 12,
					    &modulePAStat->start[CMDQ_MODULE_STAT_DISP_DSI0],
					    &modulePAStat->end[CMDQ_MODULE_STAT_DISP_DSI0]);
	cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS", 13,
					    &modulePAStat->start[CMDQ_MODULE_STAT_DISP_DPI0],
					    &modulePAStat->end[CMDQ_MODULE_STAT_DISP_DPI0]);
	cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS", 14,
					    &modulePAStat->start[CMDQ_MODULE_STAT_DISP_PWM],
					    &modulePAStat->end[CMDQ_MODULE_STAT_DISP_PWM]);
	cmdq_dev_get_module_PA_by_name_stat("mediatek,DISPSYS", 15,
					    &modulePAStat->start[CMDQ_MODULE_STAT_DISP_MUTEX],
					    &modulePAStat->end[CMDQ_MODULE_STAT_DISP_MUTEX]);
