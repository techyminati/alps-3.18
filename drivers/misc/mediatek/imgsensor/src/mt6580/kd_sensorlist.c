	...
	case SENSOR_FEATURE_GET_CROP_INFO:
		{
			...
			unsigned long long *pFeaturePara_64 = (unsigned long long *)pFeaturePara;
			MUINT32 *usr_ptr = (MUINT32 *) (uintptr_t) (*(pFeaturePara_64 + 1));
	...
	case SENSOR_FEATURE_GET_VC_INFO:
		{
			...
			*(pFeaturePara_64 + 1) = pVcInfo;
/*   		*(pFeaturePara_64 + 1) = (uintptr_t)(void*)pVcInfo;*/
			if (g_pSensorFunc) {
				ret =
				    g_pSensorFunc->SensorFeatureControl(pFeatureCtrl->InvokeCamera,
									pFeatureCtrl->FeatureId,
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		{
			...
			if (pFeaturePara_64 != NULL)
				*((MUINT32 *) (uintptr_t) (pFeaturePara_64 + 1)) = pPdaf_data;
